...
// Dinamično računanje trenutne godine
...
<template>
  <footer class="mt-20 bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left mb-12">
        ...
        <div class="flex flex-col items-center md:items-start">
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">Kontakt</h3>
          <div class="space-y-3">
            <div v-for="info in contactInfo" :key="info.text" class="flex items-center justify-center md:justify-start space-x-2">
              <UIcon :name="info.icon" class="h-5 w-5 text-emerald-600 dark:text-emerald-400 flex-shrink-0" />
              ...
              <component
                  ...
                  :class="{ 'hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors': info.link }"
              >
                {{ info.text }}
              </component>
            </div>
        ...
        <div class="flex flex-col items-center md:items-start">
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">Radno vrijeme</h3>
          <div class="space-y-2 w-full max-w-[200px]">
            <div v-for="time in workingHours" :key="time.day" class="flex justify-between text-sm">
              ...
              <span
                  class="font-medium"
                  :class="[
                  time.hours === 'Zatvoreno' ? 'text-red-500 dark:text-red-400' :
                  time.hours === 'Po dogovoru' ? 'text-emerald-600 dark:text-emerald-400' :
      ...
      <div class="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p class="text-gray-500 dark:text-gray-400 text-sm text-center md:text-right">
